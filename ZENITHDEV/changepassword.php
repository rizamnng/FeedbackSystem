  ...
  $message= '';
    ...
    if($new == $confirm_new && strlen($new)>=8){
      ...
      if( !empty($new) && password_verify($old, $user_data['password'])){
        $query = "update user set password= '$hashed_password' where id_index= $id ";
...
<html lang="en" dir="ltr">
  ...
  <body>
		<div class="log">
	      ...
	      <input class="form-control box" type="password" name="old" placeholder="Enter Current Password" required ><br><br>

	      <input class="form-control box" type="password" name="new" placeholder="Enter New Password" required><br><br>

        <input class="form-control box"  type="password" name="confirm_new" placeholder="Confirm New Password" required> <br><br>
